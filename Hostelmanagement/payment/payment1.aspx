<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="payment1.aspx.cs" Inherits="ARS.payment.payment1" %>
										...
										<div class="payment-info">
											...
											<h3 class="pay-title" style="color:blue">Credit Card Info</h3>
												...
												<div class="tab-for">				
													...
													<asp:HyperLink ID="HyperLink1" runat="server" NavigateUrl="~/payment/Payment_booking.aspx">Another Account</asp:HyperLink>	
													
												</div>	
												
											<center>    <asp:Button ID="BtnPay" runat="server" Text="PAY NOW"  style="background-color:blue;color:white" /></center>
