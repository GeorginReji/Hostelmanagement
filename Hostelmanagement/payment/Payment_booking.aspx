<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Payment_booking.aspx.cs" Inherits="ARS.payment.Payment_booking" %>


<!DOCTYPE html>
<html>
<head>
<title  >FlyHigh Payment</title>
<!-- for-mobile-apps -->
...
<body>
	<form runat="server">
	<div class="main">
		<h1 style="color:red">FlyHigh Payment</h1>
		<div class="content">
					...
					<script type="text/javascript">
						...
						<div class="sap_tabs">
							<div id="horizontalTab" style="display: block; width: 100%; margin: 0px;">
								<div class="pay-tabs">
									<h2 style="color:blue">Select Payment Method</h2>
								...
								<div class="resp-tabs-container">
									<div class="tab-1 resp-tab-content" aria-labelledby="tab_item-0">
										<div class="payment-info">
											<h3 style="color:blue">Personal Information</h3>
												...
												<div class="tab-for">				
													<h5 style="color:blue">EMAIL ADDRESS</h5>
													<asp:TextBox ID="txtemail" runat="server"></asp:TextBox>
													<h5> NAME</h5>													
													<asp:TextBox ID="txtname" runat="server"></asp:TextBox>
												</div>			
											
											<h3 class="pay-title" style="color:blue">Credit Card Info</h3>
											
												<div class="tab-for">				
													<h5>NAME ON CARD</h5>
													<asp:TextBox ID="txtcardname" runat="server"></asp:TextBox>
													<h5>CARD NUMBER</h5>	
													<asp:TextBox ID="txtcardno" class="pay-logo" runat="server" value="0000-0000-0000-0000" onfocus="this.value = '';" onblur="if (this.value == '') {this.value = '0000-0000-0000-0000';}" required="" ></asp:TextBox>												
												...
												<div class="transaction">
													<div class="tab-form-left user-form">
														<h5>EXPIRATION</h5>
															<ul>
																<li>
																	<asp:TextBox ID="txtmon" runat="server" class="text_box" type="text" value="6" min="1" ></asp:TextBox>
																	
																</li>
																<li>
																	<asp:TextBox ID="txtyr" runat="server" class="text_box" type="text" value="1988" min="1"></asp:TextBox>
													...
													<div class="tab-form-right user-form-rt">
														...
														<asp:TextBox ID="txtcvv" runat="server" value="xxxx" onfocus="this.value = '';" onblur="if (this.value == '') {this.value = 'xxxx';}" required=""></asp:TextBox>									
													
													</div>
													<div class="clear"></div>
												</div>
												<asp:Button ID="BtnPay" runat="server" Text="PAY NOW"  style="background-color:blue;color:white" OnClick="BtnPay_Click"/>
									...
									<div class="tab-1 resp-tab-content" aria-labelledby="tab_item-1">
										<div class="payment-info">
											<h3 style="color:blue">Net Banking</h3>
											...
											<a href="#" style="background-color:blue">Continue</a>
										</div>
									</div>
									<div class="tab-1 resp-tab-content" aria-labelledby="tab_item-2">
										<div class="payment-info">
											<h3 style="color:blue">PayPal</h3>
											<h4 style="color:blue">Already Have A PayPal Account?</h4>
											<div class="login-tab">
									...
									<div class="tab-1 resp-tab-content" aria-labelledby="tab_item-3">	
										<div class="payment-info">
											...
											<h3 class="pay-title" style="color:blue">Dedit Card Info</h3>
		...
		<p class="footer" style="color:blue">Copyright © 2019 Payment Form FlyHigh. All Rights Reserved </p>
	</div>
		</form>
</body>
</html>                                                           
